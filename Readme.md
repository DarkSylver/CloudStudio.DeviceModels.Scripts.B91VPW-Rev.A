...
# Configuration Script – B91 VPW - Rev. A

This **Configuration** script is designed for the **B91 VPW** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – B91 VPW Rev. A

Este script de **Configuration** está diseñado para el modelo **B91 VPW** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
